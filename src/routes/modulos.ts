...
router.use("/bootstrap/bootstrap-icons.css", (_req: Request, res: Response) => res.sendFile(resolve(__dirname + "/../../node_modules/bootstrap-icons/font/bootstrap-icons.css")));
router.use("/bootstrap/bootstrap-icons.svg", (_req: Request, res: Response) => res.sendFile(resolve(__dirname + "/../../node_modules/bootstrap-icons/bootstrap-icons.svg")));
